      ...
      <Card className="mt-6 bg-green-50 border-l-4 border-green-500">
        ...
        <CardContent>
          <p className="text-gray-700">
            You've just executed your first piece of code using the Runlite API.
            Explore the rest of the documentation to learn about more advanced
