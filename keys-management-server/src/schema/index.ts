...
export const envSchema = z.object({
  ...
  DB_PORT: z.string().optional().transform(Number),
  DB_NAME: z.string().optional(),
  DB_USER: z.string().optional(),
  DB_PASSWORD: z.string().optional(),
  DB_POOL_MIN: z.string().optional().transform(Number).default("2"),
  DB_POOL_MAX: z.string().optional().transform(Number).default("10"),
